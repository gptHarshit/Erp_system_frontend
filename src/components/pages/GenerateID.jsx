...
import GenerateIdModel from "./GenerateIdModel";
...
function GenerateId() {
  ...
  const ID_CARD_VERSION = configs?.ID_CARD_VERSION || 1;
  const { user } = useAuth();
  ...
  const fetchData = async () => {
    ...
    if (!selectedClass || !selectedSection || !academicSession) {
      setMessage("Please select required fields and click Load Students");
  ...
  return (
    <div className="flex flex-col">
      <div className="bg-gray-200 inline-block w-fit text-black rounded-full mb-2 px-4 py-2">
        <h2 className="">Generate ID Card</h2>
      </div>
      ...
      <div className="bg-white p-5 m-2 rounded-xl shadow border">
        ...
        {message && (
          <div
            className={`mx-1 mt-1 p-1 rounded-md ${
            ...
            <table className="w-full border border-gray-300 border-collapse">
              ...
              >
                <tr>
                  ...
                  <th className="p-3 border text-center">Section</th>
      ...
      {isModalOpen && (
        <GenerateIdModel
          ...
          ID_CARD_VERSION={ID_CARD_VERSION}
