...
import PromoteModel from "./PromoteModel";
...
const PromoteStudent = () => {
  ...
  const fetchData = async () => {
    ...
    setErrorMeaage("");
    setLoading(true);
    setDataLoaded(false); // ← uncomment karo
  ...
  return (
    <div className="flex flex-col ">
      ...
      <div className="bg-white p-5 m-2 rounded-xl shadow border">
        ...
        {/* grid band karo yahan */}
        {/* Message — grid ke bahar */}
        {message && (
          <div
      ...
      {/* State 1 — Kuch select nahi hua abhi */}
      {!loading && !dataLoaded && (
          ...
          <table className="w-full border border-gray-300 border-collapse">
            ...
            >
              <tr>
                ...
                <th className="p-3 border text-center">Promote Status</th>
              </tr>
            </thead>
            <tbody>
              {students?.length > 0 ? (
